...
Begin Window SliderWindow
   ...
   Begin SliderCanvas Slider1
      ...
      BarColor        =   &c00FF0000
      BarThickness    =   0.30000001192092896
      Bold            =   False
      Border          =   True
      BorderColor     =   &c00000000
      DoubleBuffer    =   True
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  BoxColor.FillColor = Slider1.BorderColor
		  barColor.FillColor = Slider1.barColor
		  barWellColor.FillColor = Slider1.BackgroundColor
		  gradientColor.FillColor = Slider1.GradientEndColor
...
#tag Events barWellColor
	...
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
		  ...
		  #pragma Unused Y
		  Dim c As Color = Me.FillColor
		  Call SelectColor(c, "Choose a BackgroundColor Color")
		  Me.FillColor = c
		  Slider1.BackgroundColor = c
		End Function
	#tag EndEvent
#tag EndEvents
